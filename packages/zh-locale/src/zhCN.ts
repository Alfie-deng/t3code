...
const UI_TEXT: Readonly<Record<string, string>> = {
  ...
  Options: "选项",
  Speed: "速度",
  "Change effort, context, and speed": "修改推理强度、上下文和速度",
  ...
  "Maximum reasoning": "Max 推理强度",
  "Maximum reasoning depth for the hardest problems": "Max 推理深度，适合最难问题",
  "Maximum reasoning with automatic task delegation": "Max 推理强度，并自动委派任务",
  "Extra high reasoning": "极高推理强度",
