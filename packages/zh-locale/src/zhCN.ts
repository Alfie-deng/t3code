...
const UI_TEXT: Readonly<Record<string, string>> = {
  ...
  "Fill in the pending answers": "请填写待回答的问题",
  "Expand user input, 1 question": "展开用户输入，1 个问题",
  "Expand user input, {count} questions": "展开用户输入，{count} 个问题",
  "1 question": "1 个问题",
...
const T3_UI_TEXT: Readonly<Record<string, string>> = {
  ...
  "Available for Git repositories.": "仅适用于 Git 仓库。",
  "Available from a thread.": "在对话中可用。",
  "Available when a project is open.": "打开项目后可用。",
...
const EXTRA_UI_TEXT: Readonly<Record<string, string>> = {
  ...
  "No pull request on this branch yet.": "此分支尚无拉取请求。",
  ...
  "Open this branch's pull request.": "打开此分支的拉取请求。",
  ...
  "Follow system": "跟随系统",
  "Follow subagents and workflows.": "跟踪子智能体与工作流。",
  "Full path": "完整路径",
