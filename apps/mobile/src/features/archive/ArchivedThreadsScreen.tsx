        ...
        >
          <View className="min-h-12 flex-row items-center gap-2">
            ...
            <View className="min-h-11 flex-1 flex-row items-center gap-2.5 rounded-2xl bg-input px-3.5">
              ...
              />
              <TextInput
                accessibilityLabel={t("Search archived threads")}
                autoCapitalize="none"
            ...
            >
              <Pressable
                accessibilityLabel={t("Filter and sort archived threads")}
                accessibilityRole="button"
        ...
        <NativeHeaderToolbar placement="right">
          {usesNativeChrome ? (
            <NativeHeaderToolbar.Button
              accessibilityLabel={t("Refresh archived threads")}
...
function ArchivedThreadRow(props: {
  ...
  return (
    <ThreadSwipeable
      ...
      primaryAction={{
        accessibilityLabel: t(`Unarchive ${props.thread.title}`),
