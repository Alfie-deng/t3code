...
function RightPanelEmptyState(props: {
  ...
  return (
    <div
      ...
      aria-label={translateZhCnUiText("Open a surface")}
            ...
            action.available ? (
              ...
              >
                ...
                <span className="flex items-center gap-2 pe-8">
                  {actionIcon(action)}
                  <span className="font-medium text-sm">{translateZhCnUiText(action.label)}</span>
                </span>
              ...
              >
                ...
                <span className="mt-1.5 text-muted-foreground text-xs leading-relaxed">
                  {translateZhCnUiText(action.disabledReason)}
                </span>
              </div>
            ),
          )}
