    ...
    <div className="w-56 bg-popover">
      ...
      <div className="grid gap-3 p-3">
        ...
        <input
          ...
          aria-label={translateZhCnUiText("Custom hex accent color")}
          spellCheck={false}
        />
      </div>
    </div>
      ...
      <PopoverTrigger
        render={
          <button
            ...
            aria-label={translateZhCnUiText(`Choose custom accent color for ${props.displayName}`)}
          >
  ...
  return (
    <div className="grid gap-2">
      <span className="text-xs font-medium text-foreground">
        {translateZhCnUiText("Accent color")}
      </span>
      <div className="flex min-w-0 flex-wrap items-center gap-2">
        ...
        <Button
          ...
          aria-label={translateZhCnUiText(`Clear accent color for ${displayName}`)}
