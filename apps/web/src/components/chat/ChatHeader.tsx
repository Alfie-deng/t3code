            ...
            <TooltipTrigger
              render={
                <button
                  ...
                  className="group/thread-title inline-flex max-w-full min-w-0 flex-none cursor-pointer items-center gap-1 rounded-sm text-left focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring"
                />
              }
            >
