...
| 字段                                            | 值                                                                                           |
| ----------------------------------------------- | -------------------------------------------------------------------------------------------- |
| 私人 tip                                        | `02a2e7e88`（盘点更新 + 上下文压缩提示汉化；合并提交 `95a4ff73e`）                           |
| 上次合入上游                                    | `95a4ff73e`（合入上游 17 笔至 `9c7622dac`；含 v0.0.33、多提供商 PR 页、安卓手势条等）        |
| 合并基点 merge-base（相对当下 `upstream/main`） | `9c7622dac`（与官方 tip 齐平）                                                               |
| 官方 tip（已 fetch 且**已合入**私人分支）       | `9c7622dac`                                                                                  |
| 桌面安装版                                      | `/Applications/T3 Code.app` `0.0.33`（本轮覆盖：合上游 + 藏侧栏 PR；签名 Alfie Development） |
| 手机安装版                                      | 真机 production Release（合并前基线；本轮手机改动未重装）                                    |
