...
| 手机安装版                                      | 真机 Alfie iPhone 17 Pro Max · `com.jetdeng.t3code` · Release（**2026-08-15 00:54 重装**：同上游 9 笔；签名 D4SUBHNYW9）                                         |
...
- 保住：侧栏藏 PR / 藏检查更新、Clerk 中文、个人 Team、短名隐藏、Memmy、模型列表投影、发送/停止 Synara 外形、藏最终变更卡片。
